...
var options = {
    strings: ['System Administrator', 'Networking and Virtualization', 'Open source Technologies', 'Site Reliability Engineer', 'Hardware and Software Technician', 'Infrastructure management'],
    loop: true,
    typeSpeed: 70,
    backSpeed: 10
};
